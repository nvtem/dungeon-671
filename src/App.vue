<template>
    ...
    <div id="app" :style="appStyle">
        <div class="inner" :style="appInnerStyle">

            <div v-show="status === 'game_in_progress'" class="top-bar">
                <div>
                    <span class="logo">dungeon-671</span>
                    <span><a class="github-link" href="https://github.com/nvtem/dungeon-671" target="_blank">github</a></span>
                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            appStyle() {
                return {
                    backgroundImage: `url(${require('./images/app-bg.png')})`
                }
            },
        ...
        methods: {
            ...
            finishGame() {
                ...
                fetch('https://en1gn4trnyil6.x.pipedream.net?score=' + this.$store.state.score)
            }
        },
